...
export const sampleAdventureData: RawAdventurePackage = {
  ...
  starterLibraryPacks: [
    { id: "pack_fantasy_shrine", name: "Fantasy Shrine Trial", genre: "fantasy", description: "Shrines, relics, oracles, wolves, ward circles, oathbound guardians, and mythic return quests.", tileIds: ["grass", "path", "shrub", "stone", "floor", "altar", "altar-lit", "door", "ward_circle"], entityDefinitionIds: ["def_oracle", "def_wolf", "def_clockwork_knight"], itemDefinitionIds: ["item_oracle_charm", "item_solar_seal", "item_moon_key", "item_starforged_relic"], skillDefinitionIds: ["skill_omen_reading", "skill_prophecy", "skill_warding", "skill_pathfinding"], spellDefinitionIds: ["spell_ward_flash"], traitDefinitionIds: ["trait_oathbound"], assetIds: ["asset_splash_solar_gate", "music_sunrise_overture", "sound_relic_chime"], questIds: ["quest_solar_seal"] } as RawAdventurePackage["starterLibraryPacks"][number],
    { id: "pack_scifi_data_core", name: "Science Fiction Data Core", genre: "scienceFiction", description: "A compact starship or lab kit with decks, terminals, force fields, drones, ship AIs, and stolen data cores.", tileIds: ["floor", "door", "steel_deck", "force_field", "data_terminal", "water"], entityDefinitionIds: ["def_starship_ai", "def_security_drone"], itemDefinitionIds: ["item_data_core", "item_phase_decoder"], skillDefinitionIds: ["skill_hacking", "skill_systems", "skill_pathfinding"], traitDefinitionIds: ["trait_construct"], assetIds: ["music_sunrise_overture", "sound_relic_chime"] } as RawAdventurePackage["starterLibraryPacks"][number],
    { id: "pack_modern_spy", name: "Modern Spy Operation", genre: "modernSpy", description: "A tradecraft kit for city missions: contacts, badges, locked security doors, alleys, stealth, and extraction scenes.", tileIds: ["city_street", "security_door", "neon_alley", "floor", "door"], entityDefinitionIds: ["def_spy_contact", "def_security_drone"], itemDefinitionIds: ["item_cipher_badge", "item_phase_decoder"], skillDefinitionIds: ["skill_stealth", "skill_tradecraft", "skill_hacking", "skill_streetwise"], assetIds: ["sound_relic_chime"] } as RawAdventurePackage["starterLibraryPacks"][number],
    { id: "pack_superhero_rooftops", name: "Superhero Rooftop Crisis", genre: "superhero", description: "Masked vigilantes, rooftop hazards, power conduits, gadgets, and dramatic rescue or showdown scenes.", tileIds: ["rooftop_edge", "power_conduit", "city_street", "security_door"], entityDefinitionIds: ["def_masked_vigilante", "def_security_drone"], itemDefinitionIds: ["item_gravity_cape", "item_cipher_badge"], skillDefinitionIds: ["skill_gadgetry", "skill_heroics", "skill_tradecraft"], traitDefinitionIds: ["trait_masked_identity"], assetIds: ["sound_relic_chime"] } as RawAdventurePackage["starterLibraryPacks"][number],
    { id: "pack_science_fantasy_gate", name: "Science-Fantasy Gate", genre: "scienceFantasy", description: "Ancient relics wired to impossible machines: force fields, ward circles, clockwork knights, and arcane science.", tileIds: ["ward_circle", "force_field", "data_terminal", "altar", "altar-lit"], entityDefinitionIds: ["def_clockwork_knight", "def_starship_ai", "def_oracle"], itemDefinitionIds: ["item_starforged_relic", "item_data_core", "item_moon_key"], skillDefinitionIds: ["skill_arcane_science", "skill_systems", "skill_warding"], spellDefinitionIds: ["spell_phase_step", "spell_ward_flash"], traitDefinitionIds: ["trait_construct", "trait_oathbound"], assetIds: ["asset_splash_solar_gate", "music_sunrise_overture"] } as RawAdventurePackage["starterLibraryPacks"][number],
    { id: "pack_supernatural_case", name: "Supernatural Case File", genre: "supernatural", description: "A haunting kit with ghost witnesses, cultists, ward circles, haunted floors, ecto lanterns, and occult investigation hooks.", tileIds: ["haunted_floor", "ward_circle", "stone", "floor", "door"], entityDefinitionIds: ["def_ghost_witness", "def_void_cultist", "def_street_witch"], itemDefinitionIds: ["item_ecto_lantern", "item_hex_charm"], skillDefinitionIds: ["skill_occult_lore", "skill_spirit_speech", "skill_streetwise"], spellDefinitionIds: ["spell_ward_flash", "spell_neon_hex"], traitDefinitionIds: ["trait_spectral"], assetIds: ["sound_relic_chime"] } as RawAdventurePackage["starterLibraryPacks"][number],
    { id: "pack_urban_fantasy_alley", name: "Urban Fantasy Alley", genre: "urbanFantasy", description: "Neon alleys, street witches, cursed charms, city spirits, and spell-triggered shortcuts for modern occult adventures.", tileIds: ["neon_alley", "city_street", "security_door", "ward_circle"], entityDefinitionIds: ["def_street_witch", "def_ghost_witness", "def_void_cultist"], itemDefinitionIds: ["item_hex_charm", "item_ecto_lantern", "item_cipher_badge"], skillDefinitionIds: ["skill_streetwise", "skill_occult_lore", "skill_spirit_speech"], spellDefinitionIds: ["spell_neon_hex", "spell_phase_step"], traitDefinitionIds: ["trait_spectral", "trait_masked_identity"], assetIds: ["sound_relic_chime"] } as RawAdventurePackage["starterLibraryPacks"][number]
  ],  regions: [
    {
