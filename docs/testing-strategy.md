...
- Add browser editor/API coverage for AI proposal review actions once Milestone 32 moves beyond prompt submission and preview into accepted/rejected proposal state and reviewed apply UI.
